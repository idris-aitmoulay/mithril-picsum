          ...
          <GridLayout ref="container" {...getAutoResponsiveProps()}>
            {
              data.map(item => {
                ...
                <div {...getPanelProps(size[1])}>
                  <img style={{position: 'absolute'}} src={`${urlBase}/${GridSize["size-m"]}/${GridSize["size-m"]}`} alt=""/>
